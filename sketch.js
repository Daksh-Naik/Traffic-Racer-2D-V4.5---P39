//P-39 Traffic Racer 2D V3.2 ~ C38 WHTJR
//At 16-04-2021 13:20 - Remastered
...
function setup() {
    ...
    for (var i = -50000; i < 5000; i=i+400){
         var light = createSprite(550, i, 40, 10);
        light.shapeColor =rgb(200, 200, 200);
    }

    for (var i = -50000; i < 10000; i=i+400){
        var light2 = createSprite(50, i, 40, 10);
       light2.shapeColor =rgb(200, 200, 200);
   }

    testObject = createSprite(300, -24300, 420, 1000000000000);
    testObject.shapeColor = rgb(140, 140, 140);
...
function draw() {
    ...
    fill(rgb(255, 255, 255))
    textFont("Verdana");
    text("V3.2", 1270, PlayerCar.y-490);    
    ...
    if (gameState === Play) {
        ...
        text("* Hold the UP ARROW Key to accelerate, DOWN ARROW Key to reverse.", 580, PlayerCar.y-165);
