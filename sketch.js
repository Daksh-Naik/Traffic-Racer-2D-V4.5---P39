...
function setup() {
    ...
    for (var i = -49000; i < 5000; i=i+400){
        ...
        light.shapeColor =rgb(220, 220, 220);
    }

    for (var i = -49000; i < 10000; i=i+400){
        var light2 = createSprite(50, i, 40, 10);
       light2.shapeColor =rgb(220, 220, 220);
   }
    ...
    for (var i = -49000; i < 5000; i=i+300){
        var laneM = createSprite(300, i, 10, 150);
...
function draw() {
    ...
    textFont("Magneto");
    text("~ Traffic Racer 2D P5~", 1020, PlayerCar.y-490);
    fill(rgb(255, 255, 255))
    textFont("Verdana");
    text("V4.5", 1270, PlayerCar.y-490);    
    ...
    text("You have a car, you're late to your university. You've ran out of excuses of being late.", 600, PlayerCar.y-300);
    text("All you have to do is to step into your section in your university. Or, you maybe late to attend", 600, PlayerCar.y-280);
    text("your professor's (boring) lecture. ", 600, PlayerCar.y-260);
    text("* The traffic on your right is preceding, while the traffic on your left is oncoming.", 600, PlayerCar.y-200);
    text("* Hold the UP ARROW Key to accelerate, both; Down and Up arrow keys to go slow.", 600, PlayerCar.y-175);
    text("* Use Left and Right Arrow Keys to steer.", 600, PlayerCar.y-155);
    text("* Go all the way down the road, try not to hit the traffic. Travel atleast 45KMs to arrive at", 600, PlayerCar.y-135);
    text("  your destination", 602, PlayerCar.y-115);

    textFont("Comic Sans MS");
    textSize(15);
    text("Your Objective is to: ", 620, PlayerCar.y-60);
    text("1: Dodge the traffic as far as possible", 620, PlayerCar.y-40);
    text("2: Arrive at your University to win (or certainly attend the lecture).", 620, PlayerCar.y-20);
    text("3: Check your score at the end!", 620, PlayerCar.y-0);
    ...
    textFont("Verdana");
    text("Travelled Distance :"+Kilometers, 760, PlayerCar.y-170);
    ...
    if (Kilometers < -40000) {
        text("Damn, you were almost there!", 750, PlayerCar.y-140);
    }
    ...
    if (gameState === Win) {
        ...
        textFont("Georgia");
        text("Traffic Racer V5 releasing soon!", 750, PlayerCar.y-70);
        text("Survival Points : "+Survival, 800, PlayerCar.y-320);
